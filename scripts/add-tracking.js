...
document.addEventListener('click', function(e) {
  ...
  console.log('‚ú‚Ä¶ Scroll + click tracking added');
} else if (!hasGA) {
  console.log('‚ù≈í GA tag missing');
} else {
  console.log('‚ö†Ô∏¬è Check status:', hasScrollTracking ? 'scroll OK' : 'scroll MISSING', hasClickTracking ? 'click OK' : 'click MISSING');
}
