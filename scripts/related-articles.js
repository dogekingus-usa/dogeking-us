 ...
 * Crown DS â€˝ Automatically displays related articles on article pages
        ...
        section.innerHTML = `
            <div class="container">
                <h2 class="section-title" style="text-align:center;margin-bottom:2rem;">
                    <span class="gold" style="font-size:1.8rem;">ðŸÅ“Å¡ Related Articles</span>
                </h2>
                <div class="related-grid" style="display:grid;grid-template-columns:repeat(auto-fill,minmax(280px,1fr));gap:1.5rem;">
                    ${related.map(a => `
                        ...
                        ">
                            ...
                            ${a.readTime ? `<div style="margin-top:0.75rem;font-size:0.75rem;color:var(--text-muted,#666);">â± ${a.readTime}</div>` : ''}
                        </a>
                    `).join('')}
                </div>
            </div>
