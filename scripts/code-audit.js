...
console.log('Systemâ†â„¢404 blocks:', (r.match(/\/404 301/g)||[]).length);
...
try {
  ...
  console.log('dynamic-loader.js: âœâ€¦ syntax OK');
} catch(e) {
  if (e instanceof SyntaxError) console.log('dynamic-loader.js: âÅ’', e.message);
  else console.log('dynamic-loader.js: âœâ€¦ syntax OK (runtime error expected)');
}
