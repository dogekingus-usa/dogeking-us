...
<span style="font-size:1.4rem;">ğŸÅ“¥</span><div><div style="font-size:1.1rem;font-weight:700;color:#f5f5ff;">500+</div><div style="font-size:0.75rem;color:#8080a0;">Traders</div></div></div>
<div style="display:flex;align-items:center;gap:10px;background:rgba(255,215,0,0.08);border:1px solid rgba(255,215,0,0.15);border-radius:10px;padding:10px 18px;">
